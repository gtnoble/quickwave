...
/**
 * @brief 
 * real double-precision element type circular buffer. Stores the `n_elements` most recently inserted elements.
...
/**
 * @brief 
 * complex double-precision element type circular buffer. Stores the `n_elements` most recently inserted elements.
 * Older elements are overwritten
 */
typedef struct {
    size_t n_elements; /** Number of elements in the buffer */
...
/**
 * @brief 
 * real single-precision element type circular buffer. Stores the `n_elements` most recently inserted elements.
 * Older elements are overwritten
 */
typedef struct {
    size_t n_elements; /** Number of elements in the buffer */
...
/**
 * @brief 
 * complex single-precision element type circular buffer. Stores the `n_elements` most recently inserted elements.
 * Older elements are overwritten
 */
typedef struct {
    size_t n_elements; /** Number of elements in the buffer */
