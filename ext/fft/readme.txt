...
Difference of the Files:
    "fft4g*.c" are optimized for most machines.
    "fft8g*.c" are fast on the UltraSPARC.
    "fftsg*.c" are optimized for the machines that 
    have the multi-level (L1,L2,etc) cache.
    The simple versions "fft*g_h.c" use no work area, but 
    the fast versions "fft*g.c" use work areas.
    The fast versions "fft*g.c" have the same specification.
